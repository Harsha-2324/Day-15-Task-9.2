...
let div1h1 = titledivchild(
  "h1",
  "id",
  "title",
  "HTML-FORM With DOM Manipulation"
);
let div1p = titledivchild(
  "p",
  "id",
  "description",
  " Fill Out the Form and Choose Two Minimum Favourite Foods!"
);
...
let food_input2 = fooditemsinput(
  ...
  "food",
  "value",
  "2) Chicken-Fried Steak, United States of America  ",
  "class",
  "checkbox"
);
...
//----------------------------------------------------------------
let food_label1 = fooditemslabel(
  "label",
  "for",
  "food",
  "Idli and Medu Vada, India"
);
let food_label2 = fooditemslabel(
  "label",
  "for",
  "food",
  "Chicken-Fried Steak, United States of America"
);
let food_label3 = fooditemslabel(
  "label",
  "for",
  "food",
  "Margherita Pizza, Italy"
);
let food_label4 = fooditemslabel("label", "for", "food", "Hamburger, Germany");
let food_label5 = fooditemslabel("label", "for", "food", "Sushi, Japan");
